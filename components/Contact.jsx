        ...
        <div className="grid md:grid-cols-2 md:w-[100%] gap-2 sm:gap-4 justify-center place-content-center items-center my-12 mx-6">
          <div className="space-y-4">
            <img
              ...
              className="animate"
            />
            <h2 className=" animate text-4xl md:text-5xl lg:text-7xl font-light tracking-wider font-customL">
              We simplify the bussiness of life
            </h2>
            <p className="animate text-3xl font-thin font-customL ">Mail Now</p>
            <a
              href="#"
              className="animate text-2xl lg:text-4xl font-extrabold text-customBlue font-customB"
            >
              contact@alwaysonqr.com
            </a>
          </div>
          <div className="bg-white animate rounded-2xl backdrop-filter shadow-[0_4px_6px_rgba(0,0,0,0.12)] p-6 md:p-8 lg:p-16">
            <form action="">
              <div className="flex flex-col space-y-4">
                <h2 className="animate text-2xl md:text-4xl font-bold font-customB">
                  Want to know more?
                </h2>
                <input
                  type="text"
